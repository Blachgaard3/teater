...
function openBook() {
  ...
  function openKaffe() {
    document.getElementById("kaffeOverlay").style.width = "100%";
  ...
  function openVd() {
    document.getElementById("vdOverlay").style.width = "100%";
  ...
  function openCt() {
    document.getElementById("ctOverlay").style.width = "100%";
  ...
  function openOel() {
    document.getElementById("oelOverlay").style.width = "100%";
  ...
  function openVin() {
    document.getElementById("vinOverlay").style.width = "100%";
    document.getElementById("kaffeOverlay").style.width = "0%";
  ...
  function openSprit() {
    document.getElementById("spritOverlay").style.width = "100%";
    document.getElementById("kaffeOverlay absinOverlay vinOverlay oelOverlay ctOverlay vdOverlay").style.width = "0%";
  }
  ...
  function openAbsin() {
    document.getElementById("absinOverlay").style.width = "100%";
    document.getElementById("kaffeOverlay spritOverlay vinOverlay oelOverlay ctOverlay vdOverlay").style.width = "0%";
